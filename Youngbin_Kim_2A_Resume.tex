...
\begin{itemize}[leftmargin=1cm ] \itemsep -0.5pt
	\item Developed multiple business-critical core features including user-schedulable/filterable csv/xls data export, payment refund, action triggered emails using Ruby/Rails, React/ReduxSaga, GraphQL, MongoDB and PostgreSQL  
	\item Automated ledger syncing process for 15 currencies and Zendesk support ticket creation in Ruby
	\item Resolved and prevented clients reported issues by fixing bad data and bugs in the code
	\item Created a weekly reporting Slack bot and a GitHub repository finder during internal hackathons 
	\item Monitored a ticket sale with a flow of near 30,000 user count
\end{itemize}
...
\vspace{-2mm}
\begin{itemize}[leftmargin= 1cm]\itemsep -0.5pt
	\item Productivity Chrome extension that blocks users from accessing websites that they choose.
\end{itemize}
\vspace{-1mm}
{\textbf{\normalsize youngbin-kim.com}}\\
\vspace{-2mm}
\begin{itemize}[leftmargin= 1cm]\itemsep -0.5pt
	\item Personal website built in React/Gatsby/Netlify. Can be accessed using QR Code above.
\end{itemize}
\vspace{-1mm}
...
\begin{itemize}[leftmargin=*]\itemsep -0.5pt
	...
	\item \textbf{Tools/Frameworks: } Rails/Sidekiq, RSpec, React/ReduxSaga, Ember, AWS, WPF, BLE\\
