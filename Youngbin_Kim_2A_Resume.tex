...
\begin{itemize}[leftmargin=1cm ] \itemsep -0.5pt
	\item Developed multiple business-critical core features including custom schedulable/filterable csv data export for event hosts, payment refund, action triggered emails using Ruby/Rails, React/ReduxSaga, CoffeeScript/Ember, GraphQL, MongoDB and PostgreSQL  
